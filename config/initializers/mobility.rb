Mobility.configure do
  ...
  plugins do
    ...
    # Fallbacks
    #
    # Untranslated English content falls back to the original Spanish
    # rather than rendering blank, since translation rolls out gradually
    # via the admin Translations panel.
    fallbacks(en: :es)
