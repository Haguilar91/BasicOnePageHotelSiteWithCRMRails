...
class PageContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create page_content" do
    assert_difference("PageContent.count") do
      post page_contents_url, params: { page_content: { content: @page_content.content, key: @page_content.key, title: @page_content.title } }
    end
  ...
  test "should update page_content" do
    patch page_content_url(@page_content), params: { page_content: { content: @page_content.content, key: @page_content.key, title: @page_content.title } }
