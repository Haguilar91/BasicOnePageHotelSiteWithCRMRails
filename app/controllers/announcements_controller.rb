class AnnouncementsController < ApplicationController
  ...
  def create
    ...
    if @announcement.save
      redirect_to @announcement, notice: "Announcement was successfully created.", status: :see_other
    else
  ...
  private
    ...
    def announcement_params
      params.expect(announcement: [ :title, :description, :start_date, :end_date, :active ])
    end
end